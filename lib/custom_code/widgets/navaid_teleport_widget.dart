...
// Wrapper لربط الكود (Ident) بالداتا عشان نعرضه كبير
class NavaidResult {
  final String ident;
...
class _NavaidTeleportWidgetState extends State<NavaidTeleportWidget> {
  ...
  final TextEditingController _hdgCtrl =
      TextEditingController(text: "060"); // خانة الـ Heading الجديدة
  ...
  void _updateDialFromPan(Offset localPos, Size size) {
    ...
    setState(() {
      ...
      _hdgCtrl.text = formattedAngle; // تحديث الـ Heading أوتوماتيك مع الراديال
      _recalcTarget();
    });
  }
  ...
  void _updateDialFromText(String val) {
    ...
    if (a != null) {
      setState(() {
        _dialAngle = a % 360;
        _hdgCtrl.text = _dialAngle
            .round()
            .toString()
            .padLeft(3, '0'); // تحديث الـ Heading أوتوماتيك مع الراديال
        _recalcTarget();
      });
    }
  }
  ...
  void _recalcTarget() {
    ...
    // حساب الإحداثيات بيتم باستخدام الراديال فقط لوضع الطيارة في المكان المظبوط
  ...
  void _teleport() {
    ...
    // حفظ الأرقام الخام (Decimal) في الـ App States بدون سناك بار
    // بيتم حفظ الـ Heading المكتوب في الخانة المستقلة لتوجه الطيارة
    FFAppState().update(() {
  ...
  Widget build(BuildContext context) {
    return Stack(clipBehavior: Clip.none, children: [
      ...
      Container(
          ...
          // ScrollView لحماية الشاشة من الـ Overflow في الآيباد بالعرض
                    ...
                    SizedBox(
                        ...
                        child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintStyle:
                                    const TextStyle(color: Color(0xFF455A75)),
                                ...
                                child: Stack(
                                    ...
                                    children: [
                                      CustomPaint(
                                          ...
                                          painter: _selectedNavaid!.model.type
                                                  .contains('VOR')
                                              ? GlowingVORPainter()
                                              : GlowingNDBPainter()),
                                      Positioned(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                const Padding(
                                    ...
                                    child: Text(
                                        'Set the radial, heading, distance, and altitude to teleport to this Navaid.',
                                        style: TextStyle(
                                            color: Color(0xFF6B87A8),
                                            fontSize: 12))),
