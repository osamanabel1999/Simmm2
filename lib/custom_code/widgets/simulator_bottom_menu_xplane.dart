...
class SimulatorBottomMenuXplane extends StatefulWidget {
  const SimulatorBottomMenuXplane({
    super.key,
    this.width,
    this.height,
    this.positionAction,
  ...
  @override
  State<SimulatorBottomMenuXplane> createState() =>
      _SimulatorBottomMenuXplaneState();
}

class _SimulatorBottomMenuXplaneState extends State<SimulatorBottomMenuXplane> {
  int? _selectedIndex;
  int? _pressedIndex;
