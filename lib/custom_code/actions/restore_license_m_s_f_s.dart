...
Future<String> restoreLicenseMSFS() async {
  const String token =
  ...
  // 2. البحث في Airtable برقم الجهاز
  ...
  try {
    ...
    // لو ملئناش أي رخصة شغالة من كل الرخص المرتبطة بالـ DeviceID
    ...
    // حفظ تاريخ الانتهاء في App State
    FFAppState().licenseExpiryDateMSFS = formatDateOnly(validExpiryDate);
