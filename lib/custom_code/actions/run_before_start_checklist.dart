...
Future<void> runBeforeStartChecklist() async {
  ...
  if (Platform.isIOS) {
    ...
    await flutterTts.setIosAudioCategory(
      IosTextToSpeechAudioCategory.playback, // Playback only
      [
  ...
  await flutterTts.awaitSpeakCompletion(true); // مهم جداً لمنع تداخل الأصوات

  // قائمة Before Start (تم تنظيف الإجابات لتكون كلمة واحدة للنطق)
