...
class IPpageXplaneWidget extends StatefulWidget {
  const IPpageXplaneWidget({super.key});

  static String routeName = 'IPpageXplane';
  static String routePath = '/iPpageXplane';

  @override
  State<IPpageXplaneWidget> createState() => _IPpageXplaneWidgetState();
}

class _IPpageXplaneWidgetState extends State<IPpageXplaneWidget> {
  late IPpageXplaneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IPpageXplaneModel());
