...
Future<void> runB737AfterTakeoffChecklist() async {
  ...
  // قائمة B737 AFTER TAKEOFF Checklist من الكارت - دون أي مساس بالنصوص
  List<Map<String, String>> checklist = [
    {'q': 'ENGINE BLEEDS', 'a': 'ON'},
    {'q': 'PACKS', 'a': 'AUTO'},
    {'q': 'LANDING GEAR', 'a': 'UP AND OFF'},
    {'q': 'FLAPS', 'a': 'UP, NO LIGHT'},
  ];
  ...
  try {
    // إعلان بدء القائمة
    await speakCaptain("AFTER TAKEOFF CHECK LIST");
    ...
    await speakCaptain("AFTER TAKEOFF CHECK LIST COMPLETED");
  } finally {
