...
Future<void> runB737DescentChecklist() async {
  ...
  // قائمة B737 DESCENT Checklist من الكارت - دون أي مساس بالنصوص
  List<Map<String, String>> checklist = [
    {'q': 'PRESSURIZATION', 'a': 'LANDING ALTITUDE SET'},
    {'q': 'RECALL', 'a': 'CHECKED'},
    {'q': 'LANDING PERFORMANCE CALCULATION', 'a': 'DONE'},
    {'q': 'AUTOBRAKE', 'a': 'SET'},
    {'q': 'LANDING DATA', 'a': 'VREF AND MINIMUMS SET'},
    {'q': 'APPROACH BRIEFING', 'a': 'COMPLETED'},
  ];
  ...
  try {
    // إعلان بدء القائمة
    await speakCaptain("DESCENT CHECK LIST");
    ...
    await speakCaptain("DESCENT CHECK LIST COMPLETED");
  } finally {
