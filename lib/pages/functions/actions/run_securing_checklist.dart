...
Future<void> runSecuringChecklist() async {
  ...
  // قائمة Securing The Aircraft Checklist - دون أي مساس بالنصوص
  ...
  try {
    // إعلان بدء القائمة
    await speakCaptain("SECURING THE AIRCRAFT CHECK LIST");
    ...
    await speakCaptain("SECURING CHECK LIST COMPLETED");
  } finally {
