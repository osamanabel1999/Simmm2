...
Future<void> runB737BeforeTakeoffChecklist() async {
  ...
  // قائمة B737 BEFORE TAKEOFF Checklist من الكارت - دون أي مساس بالنصوص
  List<Map<String, String>> checklist = [
    {'q': 'FLAPS', 'a': 'SET, GREEN LIGHT'},
    {'q': 'STABILIZER TRIM', 'a': 'SET, UNITS'},
    {'q': 'STROBE LIGHTS', 'a': 'ON'},
  ];
  ...
  try {
    // إعلان بدء القائمة
    await speakCaptain("BEFORE TAKEOFF CHECK LIST");
    ...
    await speakCaptain("BEFORE TAKEOFF CHECK LIST COMPLETED");
  } finally {
