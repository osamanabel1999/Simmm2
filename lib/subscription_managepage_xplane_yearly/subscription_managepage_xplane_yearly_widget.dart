...
import 'subscription_managepage_xplane_yearly_model.dart';
export 'subscription_managepage_xplane_yearly_model.dart';

class SubscriptionManagepageXplaneYearlyWidget extends StatefulWidget {
  const SubscriptionManagepageXplaneYearlyWidget({super.key});

  static String routeName = 'subscriptionManagepageXplaneYearly';
  static String routePath = '/subscriptionManagepageXplaneYearly';

  @override
  State<SubscriptionManagepageXplaneYearlyWidget> createState() =>
      _SubscriptionManagepageXplaneYearlyWidgetState();
}

class _SubscriptionManagepageXplaneYearlyWidgetState
    extends State<SubscriptionManagepageXplaneYearlyWidget> {
  late SubscriptionManagepageXplaneYearlyModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => SubscriptionManagepageXplaneYearlyModel());
